...
- Dipilih saat menerbitkan (Langkah 2 / jalur darurat, bagian *Peruntukan*), dan **bisa diubah kapan saja**: `admin.html` → *Daftar paket → ubah*, atau dasbor guru → *Peruntukan ujian → Ubah peruntukan* (PIN guru/operator).
